...
import type { Biodata as _Biodata, ContactInfo as _ContactInfo, ExternalBlob as _ExternalBlob, FamilyInfo as _FamilyInfo, Horoscope as _Horoscope, PersonalInfo as _PersonalInfo, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createOrUpdateBiodata(arg0: PersonalInfo, arg1: FamilyInfo, arg2: Horoscope, arg3: ContactInfo, arg4: ExternalBlob | null, arg5: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createOrUpdateBiodata(arg0, arg1, arg2, arg3, await to_candid_opt_n8(this._uploadFile, this._downloadFile, arg4), arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteBiodata(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteBiodata();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllBiodatas(): Promise<Array<Biodata>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllBiodatas();
    ...
    async getBiodata(): Promise<Biodata | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getBiodata();
    ...
    async getBiodataByPrincipal(arg0: Principal): Promise<Biodata> {
        if (this.processError) {
            try {
                const result = await this.actor.getBiodataByPrincipal(arg0);
                return from_candid_Biodata_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getPhoto(): Promise<ExternalBlob | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getPhoto();
    ...
    async getPhotoByPrincipal(arg0: Principal): Promise<ExternalBlob | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getPhotoByPrincipal(arg0);
                return from_candid_opt_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchBiodatasByCriteria(arg0: string | null, arg1: string | null, arg2: string | null, arg3: boolean | null): Promise<Array<Biodata>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchBiodatasByCriteria(to_candid_opt_n16(this._uploadFile, this._downloadFile, arg0), to_candid_opt_n16(this._uploadFile, this._downloadFile, arg1), to_candid_opt_n16(this._uploadFile, this._downloadFile, arg2), to_candid_opt_n17(this._uploadFile, this._downloadFile, arg3));
                return from_candid_vec_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchBiodatasByName(arg0: string): Promise<Array<Biodata>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchBiodatasByName(arg0);
                return from_candid_vec_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadPhoto(arg0: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadPhoto(await to_candid_ExternalBlob_n9(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Biodata_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Biodata): Promise<Biodata> {
...
async function from_candid_opt_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Biodata]): Promise<Biodata | null> {
    return value.length === 0 ? null : await from_candid_Biodata_n11(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        templatePreference: value.templatePreference,
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Biodata>): Promise<Array<Biodata>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Biodata_n11(_uploadFile, _downloadFile, x)));
}
...
function to_candid_opt_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: boolean | null): [] | [boolean] {
    return value === null ? candid_none() : candid_some(value);
}
